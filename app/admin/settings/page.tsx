...
import { Save, Globe, Coins, ShieldAlert, UserCheck } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const handleToggle = (name: "allowPreorders") => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    updateSettings(form);
    alert(
      "Store parameters saved successfully and logged in security audit logs!"
    );
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-brand-ink dark:text-white font-sans">
            Settings Panel
          </h1>
          <p className="text-zinc-500 text-sm">
            Configure regional currency rules, VAT calculations, shipping
            coefficients, and API tokens.
          </p>
        </div>
        <button
          onClick={handleSave}
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm space-y-4">
            <h2 className="text-base font-bold text-brand-ink dark:text-white pb-3 border-b border-black/5 dark:border-white/5 flex items-center gap-2">
              <Globe className="h-4.5 w-4.5 text-brand-blue" /> Store Identity &
              Profile
            </h2>
          ...
          <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm space-y-4">
            <h2 className="text-base font-bold text-brand-ink dark:text-white pb-3 border-b border-black/5 dark:border-white/5 flex items-center gap-2">
              <Coins className="h-4.5 w-4.5 text-emerald-500" /> Regional
              Pricing & Taxes
            </h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col justify-end pb-1.5">
                <span className="text-xs font-bold text-zinc-500 mb-2">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm space-y-4">
            <h3 className="font-bold text-brand-ink dark:text-white flex items-center gap-2">
              <ShieldAlert className="h-4.5 w-4.5 text-rose-500" /> Security
              Policies
            </h3>
          ...
          <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm space-y-4">
            <h3 className="font-bold text-brand-ink dark:text-white flex items-center gap-2">
              <UserCheck className="h-4.5 w-4.5 text-brand-blue" /> Admin
              Accounts
            </h3>
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={admin.name}
                  className="flex justify-between items-center text-xs border-b border-black/5 dark:border-white/5 pb-2"
                >
