    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-500 text-sm">
            Deep-dive customer conversion, revenue performance, and category
            metrics.
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm">
          <div className="pb-4 mb-4 border-b border-black/5 dark:border-white/5">
            ...
            <p className="text-xs text-zinc-400">
              Tracking daily intake vs targets
            </p>
          </div>
          <div className="h-64 py-4">
            ...
            >
              ...
              <path
                d="M 0 190 Q 120 70 250 110 T 500 25 L 500 190 Z"
                fill="url(#purpleGrad)"
              />
              <path
                d="M 0 190 Q 120 70 250 110 T 500 25"
                fill="none"
                stroke="#a855f7"
                strokeWidth="3"
              />
        ...
        <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm">
          <div className="pb-4 mb-4 border-b border-black/5 dark:border-white/5">
            ...
            <p className="text-xs text-zinc-400">
              Where traffic finds TroyX store
            </p>
          </div>
          <div className="h-64 py-4 flex flex-col justify-center gap-4">
            {[
              ...
              {
                source: "Social Media (Instagram/X)",
                percentage: 29,
                visitors: "5.3k",
                color: "bg-purple-500"
              },
      ...
      <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm">
        <div className="pb-4 mb-4 border-b border-black/5 dark:border-white/5">
          ...
          <p className="text-xs text-zinc-400">
            Products with the highest revenue conversion rates this month
          </p>
        </div>
              ...
              {products.slice(0, 5).map((product, index) => (
                ...
                >
                  ...
                  <td className="py-4 text-right text-emerald-600 dark:text-emerald-400">
                    {(4.8 - index * 0.4).toFixed(2)}%
                  </td>
                  <td className="py-4 text-right text-brand-blue font-bold">
                    ₵{(product.price * (32 - index * 5)).toLocaleString()}
                  </td>
                </tr>
              ))}
            </tbody>
