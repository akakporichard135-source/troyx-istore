...
export default function CustomersPage() {
  const { customers, orders, addCustomerNote } = useAdminStore();
  ...
  const customerOrders = useMemo(() => {
    ...
    return orders.filter(
      (o) => o.email.toLowerCase() === activeCustomer.email.toLowerCase()
    );
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-zinc-500 text-sm">
          Manage user accounts, review lifecycle values, trace wishlists, and
          log communication notes.
        </p>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-sm text-brand-ink dark:text-white truncate">
                        {c.name}
                      </p>
                    ...
                    <div className="text-right">
                      <p className="text-xs font-black text-brand-ink dark:text-white">
            ...
            <>
                ...
                <div className="flex items-center gap-4 pb-5 border-b border-black/5 dark:border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">
                      Customer ID: {activeCustomer.id} | Joined:{" "}
                    ...
                    <div className="pt-4 border-t border-black/5 dark:border-white/5 space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {activeCustomer.wishlist.map((w) => (
                          <span
                            key={w}
                            className="text-xs px-3 py-1 bg-zinc-50 border border-black/5 dark:bg-zinc-800 dark:border-white/5 text-zinc-700 dark:text-zinc-300 rounded-full font-semibold"
                          >
                            {w}
                          </span>
                        ))}
                ...
                {customerOrders.length > 0 ? (
                  <div className="divide-y divide-black/5 dark:divide-white/5">
                    {customerOrders.map((o) => (
                      <div
                        key={o.id}
                        className="py-3 flex justify-between items-center text-xs font-bold"
                      >
                        <div>
                        ...
                        <div className="text-right">
                          <p className="text-brand-ink dark:text-white">
                  ...
                  <p className="text-xs text-zinc-400 italic">
                    No checkout orders registered for this email address.
                  </p>
                )}
              </div>
              ...
              <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-sm space-y-4">
                <h3 className="font-bold text-brand-ink dark:text-white flex items-center gap-2">
                  <MessageSquare className="h-4 w-4 text-brand-blue" /> CRM
                  Notes & Log
                </h3>
