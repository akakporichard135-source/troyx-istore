...
export function Button({
  ...
  return (
    <button
      className={cn(
        "focus-ring inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-sm font-bold transition active:scale-[0.98]",
        variant === "primary" &&
          "bg-brand-blue text-white shadow-lg shadow-blue-500/20 hover:bg-blue-600 hover:shadow-blue-500/30",
        variant === "secondary" &&
        ...
        variant === "dark" &&
          "bg-brand-ink text-white hover:bg-black dark:bg-white dark:text-brand-ink",
        className
      )}
      {...props}
    />
